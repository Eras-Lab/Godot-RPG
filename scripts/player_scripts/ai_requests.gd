...
func _on_http_request_request_completed(result, response_code, headers, body):
	...
	if action_name == "walk_to":
		...
		action_functions.wrapped_walk_towards(location_name)
		...
		action_functions.wrapped_pick_up_item()
		...
		action_functions.wrapped_trade()
		...
		action_functions.wrapped_buy_item(item_name, quantity, external_store, external_currency_manager)
		...
		action_functions.wrapped_train(training_location_name)
		...
		action_functions.wrapped_craft()
